...
一个面向普通成年人的中文饮食减脂记录 Skill。接收餐食照片或简单描述，估算热量、蛋白质和碳水，持续写入 CSV，并用简洁进度条反馈当天摄入；支持月度体重复核以及离线 HTML 周报、月报。
...
| 指标 | 今日累计 / 目标 | 进度 | 判断 |
|---|---:|---|---|
| 热量 | 1000 / 2000 kcal | `█████░░░░░ 50%` | 合适 |
| 蛋白质 | 60 / 100～130 g | `██████░░░░ 60%` | 偏低 |
| 碳水 | 110 / 220～270 g | `█████░░░░░ 50%` | 合适 |
| 条件体重变化 | 若今天此后不再进食：模型区间 | — | 理论能量等价·低可信 |
```
...
当前 V4 测试覆盖每日区间、额外有氧、肥胖程度差异、缺失数据、月度覆盖门槛、平滑限幅、HTML 报告及简洁输出契约。
